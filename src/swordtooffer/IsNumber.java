...
public class IsNumber {
    public boolean isNumber(String s) {
        ...
        return state == State.STATE_END || state == State.STATE_INTEGER || state == State.STATE_POINT
                || state == State.STATE_EXP_NUM || state == State.STATE_FRACTION;
    ...
    enum State {
        STATE_START, STATE_INT_SIGN, STATE_INTEGER, STATE_POINT, STATE_POINT_WITHOUT_INT, STATE_FRACTION, STATE_EXP,
        STATE_EXP_SIGN, STATE_EXP_NUM, STATE_END
    }
    ...
    public static void main(String[] args) {
        var o = new IsNumber();
        System.out.println(o.isNumber("e"));
    }
